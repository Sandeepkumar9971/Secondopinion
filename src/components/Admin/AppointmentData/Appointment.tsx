...
const Appointment = () => {
    ...
    return (
        <>
            {dataadd ? (
                <AppointmentAdd data={"add data"} setdataadd={setDataAdd} onSubmit={function (formData: any): void {
                            ...
                            <table className="min-w-full">
                                <thead>
                                    <tr>
                                        ...
                                        <th className="px-6 py-3 border-b-2 border-gray-300 text-left text-sm leading-4 text-blue-500 tracking-wider">Speciality</th>
